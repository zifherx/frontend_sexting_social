<template>
  <v-card v-bind="$attrs" :class="classes" class="v-card--material pa-3">
    <div class="d-flex grow flex-wrap">
      <v-avatar v-if="avatar" size="200" class="mx-auto v-card--material__avatar elevation-6" color="grey">
        <v-img :src="avatar" />
      </v-avatar>
      ...
      <div v-else-if="icon && title" class="ml-4">
        <div class="display-3 card-title font-weight-light" v-text="title" />
      </div>
    </div>
